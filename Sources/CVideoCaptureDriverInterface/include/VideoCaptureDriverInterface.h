...
typedef struct vcdi_instance_session_t {
    // Vendor driver private context data
    void *context;
...
typedef struct vcdi_instance_registration_data_t {
    ...
    vcdi_instance_session_t * NULLABLE_RETURN (* NULLABLE_SYMBOL open_session)(void);
...
typedef bool (vcdi_library_entrypoint_t)(vcdi_instance_t *instance);
